...
// Reject all splited stake blocks under 200 XLT
...
//!<DuzyDoc>: Stake - singleton class encapsulating PoS feature for Nexalt.
...
private:
    ...
    void StakingThread(CWallet *wallet, CConnman* connman);
...
public:
    ...
    void GenerateStakes(boost::thread_group &group, CWallet *wallet, int procs, CConnman* connman);
};
