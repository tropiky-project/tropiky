    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given tropiky address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The tropiky address to validate"},
                },
                RPCResult{
            "{\n"
            ...
            "}\n"
                ...
                RPCExamples{
                    HelpExampleCli("validateaddress", "\"Tx28wvomqVUy6PZVsgjb2L4eJyHvMKgcms\"")
            + HelpExampleRpc("validateaddress", "\"Tx28wvomqVUy6PZVsgjb2L4eJyHvMKgcms\"")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The tropiky address to use for the signature."},
            ...
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("verifymessage", "\"Tx28wvomqVUy6PZVsgjb2L4eJyHvMKgcms\", \"signature\", \"my message\"")
                },
            }.ToString());
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "tropiky-cli and the GUI. There is no server-side difference.",
                {},
                RPCResults{},
                RPCExamples{""},
            }.ToString()
