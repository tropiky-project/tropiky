...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tropiky-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tropiky-tx [options] <hex-tx> [commands]  Update hex-encoded tropiky transaction\n" +
            "or:     tropiky-tx [options] -create [commands]   Create hex-encoded tropiky transaction\n" +
            "\n";
