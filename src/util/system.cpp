...
const char * const BITCOIN_CONF_FILENAME = "tropiky.conf";
bool fDebug = false;
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tropiky";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Tropiky";
#else
    // Unix
    return pathRet / ".tropiky";
#endif
#endif
}
