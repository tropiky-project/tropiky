...
{
    const char* pszTimestamp = "Tunisia's PM sacked after violent Covid protests BBC 26/jul/2021";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1627286878, 2084533188, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4a4d79ecfe35048dd7c12c7f9b05584b472829067744f4a6147eb80ab529004e"));
        assert(genesis.hashMerkleRoot == uint256S("0x2dae087e68095ba09b8c9d512e24bb8f8e8f14e5d580b5d0ae81c292a1842239"));
        ...
        //vSeeds.emplace_back("seed-a.tropiky.loshan.co.uk");
        //vSeeds.emplace_back("dns1.tropiky.info");
        vSeeds.emplace_back("dns2.tropiky.info");
        //vSeeds.emplace_back("dns3.tropiky.info");
        //vSeeds.emplace_back("tns1.tropiky.info");
        //vSeeds.emplace_back("tns2.tropiky.info");
        //vSeeds.emplace_back("tns3.tropiky.info");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x4a4d79ecfe35048dd7c12c7f9b05584b472829067744f4a6147eb80ab529004e")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.tropikytools.com");
        ...
        checkpointData = {
            {
                {0, uint256S("4a4d79ecfe35048dd7c12c7f9b05584b472829067744f4a6147eb80ab529004e")},
            }
        };
