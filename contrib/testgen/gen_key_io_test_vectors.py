...
bech32_templates = [
  ...
  ('trk',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('trk',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('trk',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('ttrk',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('ttrk',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('ttrk',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rtrk',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rtrk',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rtrk', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('ttrk',  17, 32, False, False, False),
  ('rtrk',  3,  1, False, False, False),
  ('trk',   15, 41, False, False, False),
  ('ttrk',  0, 16, False, False, False),
  ('rtrk',  0, 32, True,  False, False),
  ('trk',   0, 16, True,  False, False),
  ('ttrk',  0, 32, False, True,  False),
  ('rtrk',  0, 20, False, False, True)
]
