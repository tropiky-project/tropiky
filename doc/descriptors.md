# Support for Output Descriptors in Tropiky Core

Since Tropiky Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `trk1...` for mainnet or `ttrk1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Tropiky's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Tropiky Core wallets, a convenience function `combo` is
