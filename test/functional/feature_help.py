...
"""Verify that starting tropiky with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tropiky with -h for help text")
        ...
        self.log.info("Start tropiky with -version for version information")
        ...
        self.log.info("Start tropikyd with -fakearg to make sure it does not start")
